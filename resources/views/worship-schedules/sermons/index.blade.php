...
<div style="max-width: 1200px; margin: 0 auto; padding: 20px;">
  ...
  <div style="padding: 10px 15px 10px 0; margin-top: 15px;">
    ...
    <div style="margin-bottom: 5px;">2. Mohon semua Gembala bertanggung jawab dengan pelayanan Pertukaran pengkhotbah</div>
  </div>
</div>
    ...
    <form id="generateForm" action="{{ route('worship-schedules.sermons.generate') }}" method="POST">
      ...
      <div style="margin-bottom: 20px;">
        ...
        <ul style="margin-top: 10px; padding-left: 20px;">
          <li>Buat jadwal otomatis dari bulan (Januari - Oktober)</li>
